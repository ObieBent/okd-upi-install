...
# Disk Creation
qemu-img create -o preallocation=metadata -f qcow2 /var/lib/libvirt/pool/hdd/ocp-worker-02.caas.eazytraining.lab.qcow2 60G
...
virt-install \
 ...
 --os-variant=rhel8.0 \
 --vcpus=8 \
 --disk /var/lib/libvirt/pool/hdd/ocp-worker-02.caas.eazytraining.lab.qcow2 --boot hd,menu=on\
 --nographics \
