...
# Disk creation
qemu-img create -o preallocation=metadata -f qcow2 /var/lib/libvirt/pool/sdd/ocp-control-02.caas.eazytraining.lab.qcow2 60G 
...
virt-install \
 ...
 --vcpus=6 \
 --disk /var/lib/libvirt/pool/sdd/ocp-control-02.caas.eazytraining.lab.qcow2 --boot hd,menu=on\
 --nographics \
